      ...
      <header className="bg-[#5188c1] p-4 flex items-center gap-4 border-b border-blue-400 z-50 relative shadow-md">
        <div className="flex items-center gap-2 mr-4">
          <div className="bg-white p-1 rounded-lg shadow-sm">
            <img src="https://stack-kidi.com/wp-content/uploads/2021/05/Stack-Kidi-Logo-1.png" alt="Stack Kidi" className="h-10" referrerPolicy="no-referrer" />
          </div>
          <h1 className="text-xl font-black text-white tracking-tighter hidden sm:block">Stack Kidi</h1>
        </div>
